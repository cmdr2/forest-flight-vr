...
The main "rendering optimization" in this demo is to bake the textures in Blender, and to use Mobile/Unlit shader to draw everything. So basically nothing gets lit by Unity, not even the paper aeroplane. Like the lowpoly style choice, this too is a lazy optimization, nothing particularly clever, but works quite alright :)
