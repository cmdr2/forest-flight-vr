...
//			sb.Append ("triangles: " + triangles.Length + "\n");
...
public class ObjExporter : ScriptableObject
{
	...
	static string processTransform(Transform t, bool makeSubmeshes)
	{
		...
		if (mf) {
			meshString.Append (ObjExporterScript.MeshToString (mf.sharedMesh, t));
		} else if (smr) {
			meshString.Append (ObjExporterScript.MeshToString (smr.sharedMesh, t));
		}
